        ...
        <br>
            ...
            <div class="table-responsive">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td style="font-weight: bold">NOMBRE DEL SISTEMA</td>
                      <td>SISTEMA WEB DE AFILIACIÓN Y CANALIZACIÓN DE PERSONAS CON DISCAPACIDAD A DIVERSAS INSTITUCIONES.</td>
                    </tr>
                    <tr>
                      <td style="font-weight: bold">TECNOLOGÍAS DE DESARROLLO  </td>
                      <td>LARAVEL  9 (PHP FRAMEWORK) PARA EL BACKEND; BLADE PARA LAS VISTAS; HTML, CSS Y JAVASCRIPT PARA EL FRONTEND</td>                    </tr>
                    <tr>

                        <td style="font-weight: bold">DESARROLLADO POR
                            <br>
                            <img src="img/perfil.jpg" class="rounded"  style="width: 20%; height: 20%;" id="logo" alt="">
                        </td>
                        <td>BLADIMIR DE JESÚS ORTIZ RAMÍREZ, RESIDENTE DE INGENIERÍA INFORMÁTICA </td>
                      </tr>
                      <tr>
                        <td style="font-weight: bold">GESTIONADO & ADMINISTRADO</td>
                        <td>SISTEMA DIF MUNICIPAL DE SANTA CRUZ XOXOCOTLÁN</td>
                      </tr>
                      <tr>
                        <td style="font-weight: bold">OBJETIVO </td>
                        <td>COLABORAR MEDIANTE UN CENSO DE LA POBLACIÓN CON DISCAPACIDAD DEL MUNICIPIO DE SANTA CRUZ XOXOCOTLÁN Y QUE CON BASE EN SUS HABILIDADES FÍSICAS O COGNITIVAS PUEDAN SER CANALIZADAS A DIFERENTES INSTANCIAS PARA INTEGRARLAS AL MUNDO LABORAL, EMPLEANDO UN SISTEMA WEB.</td>
                      </tr>
                      <tr>
