        ...
        <div class="row">
          ...
          <div class="col-md-9 p-3 min-vh-100 mx-auto">
            <form action="" method="POST" style="width: 90%">
              ...
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title" style="font-weight: bold; text-align: center;">Datos Médicos</h2>
                  <br>
                  <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                      <label for="medicaldiagnosis" class="form-label-bold">Diagnóstico Médico</label>
                      <input type="text" class="form-control" id="medicaldiagnosis" name="medicaldiagnosis" placeholder="Diagnóstico Médico" value="{{ $medicalData->medicaldiagnosis }}">
                      @error('medicaldiagnosis')
                    ...
                    <div class="col-sm-6 custom-col">
                      <label for="blood_type" class="form-label-bold">Tipo de Sangre</label>
                      <input type="text" class="form-control" id="blood_type" name="blood_type" placeholder="Tipo de Sangre" value="{{ $medicalData->blood_type }}">
                      @error('blood_type')
                      <small class="txt-danger mt-1">
                        <strong>{{ $message }}</strong>
                      </small>
                  ...
                  <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                      <label for="allergies_type" class="form-label-bold">Tipo de Alergia</label>
                      <input type="text" class="form-control" id="allergies_type" name="allergies_type" placeholder="Tipo de Alergia" value="{{ $medicalData->allergies_type }}">
                      @error('allergies_type')
                      <small class="txt-danger mt-1">
                        <strong>{{ $message }}</strong>
                      </small>
                      @enderror
                    ...
                    <div class="col-sm-6 custom-col">
                      <label for="allergies" class="form-label-bold">Nombre de la Alergia</label>
                      <input type="text" class="form-control" id="allergies" name="allergies" placeholder="Nombre de la Alergia" value="{{ $medicalData->allergies }}">
                      @error('allergies')
                      <small class="txt-danger mt-1">
                        <strong>{{ $message }}</strong>
                      </small>
                  ...
                  <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                      <label for="additionaldescription" class="form-label-bold">Consideraciones Médicas Adicionales</label>
                      <input type="text" class="form-control" id="additionaldescription" name="additionaldescription" placeholder="Consideraciones Médicas Adicionales" value="{{ $medicalData->additionaldescription }}">
                    ...
                    <div class="col-sm-6 custom-col">
                      <label for="chronic_diseases" class="form-label-bold">Tipo de Enfermedad Crónica</label>
                      <input type="text" class="form-control" id="chronic_diseases" name="chronic_diseases" placeholder="Tipo de Enfermedad Crónica" value="{{ $medicalData->chronic_diseases }}">
                  ...
                  <div class="row mt-4">
                    <div class="col text-center">
                      <button type="submit" class="btn btn-primary mx-2" style="width: 200px; height: 60px; font-size: 20px;">Actualizar</button>
                      <button type="button" class="btn btn-secondary mx-2" style="width: 200px; height: 60px; font-size: 20px;">Cancelar</button>
                    </div>
                  </div>
                </div>
              </div>
