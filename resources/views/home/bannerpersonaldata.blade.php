...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/panel.css') }}">
     ...
     <link rel="stylesheet" href="{{ asset('css/bannerpersonaldata.css') }}">
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-9 p-3 min-vh-100 mx-auto">
             <form action="" method="POST" style="width: 90%">
                @csrf
            <div class="card">
              <div class="card-body">
                <h2 class="card-title" style=" font-weight: bold; text-align: center;">Datos Personales</h2>
                <br>
                <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                        <label for="personalname" class="form-label-bold">Nombre Personal</label>
                        <input type="text" class="form-control" id="personalname" name="personalname" placeholder="Nombre Personal" value="{{ $userDetails->personalname }}">
                        @error('personalname')
                    ...
                    <div class="col-sm-6 custom-col">
                        <label for="paternallastname" class="form-label-bold">Apellido Paterno</label>
                        <input type="text" class="form-control" id="paternallastname" name="paternallastname" placeholder="Apellido Paterno" value="{{ $userDetails->paternallastname }}">
                ...
                <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                        <label for="maternalastname" class="form-label-bold">Apellido Materno</label>
                        <input type="text" class="form-control" id="maternalastname" name="maternalastname" placeholder="Apellido Materno" value="{{ $userDetails->maternalastname }}">
                    ...
                    <div class="col-sm-6 custom-col">
                        <label for="birthdate" class="form-label-bold">Fecha de Nacimiento</label>
                        <input type="date" class="form-control" id="birthdate" name="birthdate" placeholder="Fecha de Nacimiento" value="{{ $userDetails->birthdate }}">
                        @error('birthdate')
                        <small class="txt-danger mt-1">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                        <label for="curp" class="form-label-bold">CURP</label>
                        <input type="text" class="form-control" id="curp" name="curp" placeholder="CURP" value="{{ $userDetails->curp }}">
                        @error('curp')
                        <small class="txt-danger mt-1">
                            <strong>{{ $message }}</strong>
                        </small>
                    ...
                    <div class="col-sm-6 custom-col">
                        <label for="gender" class="form-label-bold">Género</label>
                        <select class="form-control" name="gender">
                            <option selected disabled>Selecciona</option>
                            <option value="Hombre" @if ($userDetails->gender == 'Hombre') selected @endif>Hombre</option>
                            <option value="Mujer" @if ($userDetails->gender == 'Mujer') selected @endif>Mujer</option>
                        </select>
                        @error('gender')
                        <small class="txt-danger mt-1">
                            <strong>{{ $message }}</strong>
                ...
                <div class="row mt-2">
                    <div class="col-sm-6 custom-col">
                        <label for="cellphonenumber" class="form-label-bold">Teléfono Móvil</label>
                        <input type="text" class="form-control" id="cellphonenumber" name="cellphonenumber" placeholder="Teléfono Móvil" value="{{ $userDetails->cellphonenumber }}">
                    ...
                    <div class="col-sm-6 custom-col">
                        <label for="homenumber" class="form-label-bold">Teléfono de Casa</label>
                        <input type="text" class="form-control" id="homenumber" name="homenumber" placeholder="Teléfono de Casa" value="{{ $userDetails->homenumber }}">
                        @error('homenumber')
                        <small class="txt-danger mt-1">
                            <strong>{{ $message }}</strong>
                        </small>
                  ...
                  <div class="row mt-4">
                    <div class="col text-center">
                        <button type="submit" name="action" value="update" class="btn btn-primary mx-2" style="width: 200px; height: 60px; font-size: 20px;">Actualizar</button>
                        <button type="submit" name="action" value="cancel" class="btn btn-secondary mx-2" style="width: 200px; height: 60px; font-size: 20px;">Cancelar</button>
