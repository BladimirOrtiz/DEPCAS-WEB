...
<form action="" method="post" class="m-auto bg-white p-5 rounded-sm shadow-lg w-form ">
    @csrf
            ...
            <div class="form-group"> <!-- Birth Date -->
                ...
                <input type="date" class="form-control" id="birthdate" name="birthdate" placeholder="dia/mes/año" value="{{ old('birthdate') }}">
                @error('birthdate')
                <small class="txt-danger mt-1">
                    <strong>{{ $message }}</strong>
                </small>
            ...
            <div class="form-group"> <!-- CURP -->
                ...
                <input type="text" class="form-control" id="curp" name="curp" placeholder="CURP" value="{{ old('curp') }}">
                @error('curp')
                <small class="txt-danger mt-1">
                    <strong>{{ $message }}</strong>
                </small>
            ...
            <div class="form-group"> <!-- Gender -->
                <label for="full_name_id" class="control-label">Género</label>
            ...
            <div class="form-group"> <!-- Cellphone Number -->
                <label for="full_name_id" class="control-label">Teléfono Móvil</label>
                <input type="text" class="form-control" id="cellphonenumber" name="cellphonenumber" placeholder="Teléfono Móvil" value="{{ old('cellphonenumber') }}">
            ...
            <div class="form-group"> <!-- Home Number -->
                <label for="full_name_id" class="control-label">Teléfono de Casa</label>
                <input type="text" class="form-control" id="homenumber" name="homenumber" placeholder="Teléfono de Casa" value="{{ old('homenumber') }}">
                @error('homenumber')
                <small class="txt-danger mt-1">
                    <strong>{{ $message }}</strong>
                </small>
