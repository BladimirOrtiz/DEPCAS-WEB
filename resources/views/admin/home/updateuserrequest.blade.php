...
<head>
    ...
    <title>Actualización de Solicitudes de Usuario</title>
...
<div class="card">
   ...
   <div class="card-body">
    <form action="{{ route('request.updaterequest', ['requestfolio' => $solicitud->requestfolio]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
