                    ...
                    <div class="collapse" id="datosGenerales">
                      <div class="collapse-content">
                        <ul class="list-unstyled">
                            <li><a href="/welcomepanel/bannerpersonal" onclick="setActive(this)">Datos Personales</a></li>
                            <li><a href="/welcomepanel/banneraddress" onclick="setActive(this)">Datos de Domicilio</a></li>
                            <li><a href="/welcomepanel/bannermedical" onclick="setActive(this)">Datos Médicos</a></li>
                        </ul>
                      </div>
                    </div>
                  </li>
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="requestfolio" id="requestfolio" value="{{ $folio }}" >
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="institution_name">
                                <option selected>Selecciona</option>
                                @foreach($institution_name as $name)
                                    <option value="{{ $name }}" {{ old('institution') == $name ? 'selected' : '' }}>{{ $name }}</option>
                                @endforeach
                            </select>
                            </div>
                        <div class="mb-3">
                            <label for="sector_destined" class="form-label"><strong>Área Destinada</strong></label>
                            <select class="form-select" aria-label="Default select example" name="sector_destined">
                                <option selected>Selecciona</option>
                                @foreach($area_responsible as $area)
                                    <option value="{{ $area }}" {{ old('sector_destined') == $area ? 'selected' : '' }}>{{ $area }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="request_description" id="requestdescription" rows="5"></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="applicant_files" class="form-label"><strong>Documentos del Solicitante:</strong></label>
                            <input type="file" class="form-control-file" name="applicant_files" id="applicantfiles">
                        </div>

                        <div class="mb-3">
                            <label for="created_date" class="form-label"><strong>Fecha de Creación</strong></label>
                            <input type="date" class="form-control" name="created_date" id="created_date" value="">
                        </div>
                        <div class="mb-3">
                            <label for="creation_time" class="form-label"><strong>Hora de Creacion</strong></label>
                            <input type="time" class="form-control" name="creation_time" id="creation_time" value="">
                        </div>

                        <div id="btnrg">
                            <button type="submit" class="btn btn-primary btn-lg">Crear Solicitud</button>
                          </div>
                          <script>
                            ...
                            document.getElementById("creation_time").value = formattedTime;
    });
                        </script>
